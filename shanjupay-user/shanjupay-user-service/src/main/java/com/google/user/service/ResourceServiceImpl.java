...
import com.google.user.api.dto.resource.ResourceDTO;
import com.google.user.domain.ResourceApplication;
import com.google.user.domain.ResourceButton;
import com.google.user.domain.ResourceMenu;
import com.google.user.mapper.ResourceApplicationMapper;
import com.google.user.mapper.ResourceButtonMapper;
import com.google.user.mapper.ResourceMenuMapper;
import com.google.user.mapstruct.ResourceApplicationConvert;
...
public class ResourceServiceImpl implements ResourceService {
    ...
    private final ResourceApplicationMapper applicationMapper;
    private final ResourceMenuMapper menuMapper;
    private final ResourceButtonMapper buttonMapper;
    ...
    public void createApplication(ApplicationDTO application) {
        ResourceApplication entity = resourceApplicationConvert.toEntity(application);
    ...
    public ApplicationDTO queryApplication(String applicationCode) {
        ...
        ApplicationDTO applicationDTO = resourceApplicationConvert.toDto(application);
    ...
    public Map<Long, List<ResourceDTO>> loadResources(Map<Long, AuthorizationInfoDTO> tenantAuthorizationInfoMap) {
        ...
        if(tenantAuthorizationInfoMap.isEmpty()) {throw new BusinessException(CommonErrorCode.E_110006);}
