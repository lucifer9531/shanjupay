...
import com.google.user.api.ResourceService;
...
import com.google.user.api.dto.tenant.*;
import com.google.user.domain.*;
import com.google.user.mapper.*;
import com.google.user.mapstruct.*;
import com.google.util.MD5Util;
import com.google.util.PhoneUtil;
import com.google.util.RandomStringUtil;
...
public class TenantServiceImpl implements TenantService {
    ...
    private final BundleConvert bundleConvert;
    private final AuthorizationRoleConvert authorizationRoleConvert;
    private final AccountConvert accountConvert;
    private final ResourceApplicationConvert resourceApplicationConvert;
...
//////////////////////////////////////////租户相关的操作///////////////////////////////////////////////////
    ...
    public TenantDTO createTenantAndAccount(CreateTenantRequestDTO createTenantRequest) {
        ...
        if (isExistAccountByMobile(mobile)) {//为true表示 手机号已存在
            ...
            if (tenant == null) {
                ...
                return tenantConvert.toDto(ten);
            } else {
                return tenant;
            }
            ...
            return tenantConvert.toDto(tenant);
        }
    }
    ...
    public TenantDTO getTenant(Long id) {
        ...
        return tenantConvert.toDto(entity);
    }
    ...
    public List<BundleDTO> queryBundleByTenantType(String tenantType) {
        ...
        List<BundleDTO> dtoList = bundleConvert.toDto(bundles);
        return dtoList;
    }
    ...
    public BundleDTO getBundle(String bundleCode) {
        ...
        return bundleConvert.toDto(entity);
    }
    ...
    public List<BundleDTO> queryAllBundle() {
        ...
        return bundleConvert.toDto(bundles);
    }
    ...
    public void initBundle(Long tenantId, String bundleCode) {
        ...
        if (bundle != null && StringUtils.isNotBlank(bundle.getAbility())) {
            ...
            List<AuthorizationRole> roles = authorizationRoleConvert.toEntity(roleDTOList);
    ...
    public void createBundle(BundleDTO bundleDTO) {
        Bundle bundle = bundleConvert.toEntity(bundleDTO);
...
//            loginInfo.setResources(resources);
    ...
    public ApplicationDTO getApplicationDTOByClientId(String clientId) {
        ...
        return resourceApplicationConvert.toDto(resourceApplication);
    }
