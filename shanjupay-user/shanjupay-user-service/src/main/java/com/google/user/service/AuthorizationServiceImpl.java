...
import com.google.user.api.AuthorizationService;
import com.google.user.api.dto.authorization.AuthorizationInfoDTO;
...
import com.google.user.api.dto.tenant.TenRolePrivilegeDTO;
import com.google.user.domain.*;
import com.google.user.mapper.*;
import com.google.user.mapstruct.AuthorizationPrivilegeConvert;
import com.google.user.mapstruct.AuthorizationRoleConvert;
...
public class AuthorizationServiceImpl implements AuthorizationService {
    ...
    private final AuthorizationRoleMapper roleMapper;
    private final AuthorizationPrivilegeMapper privilegeMapper;
    private final AccountMapper accountMapper;
    private final AccountRoleMapper accountRoleMapper;
    private final AuthorizationRolePrivilegeMapper rolePrivilegeMapper;
    private final AuthorizationPrivilegeGroupMapper groupMapper;
    private final AuthorizationPrivilegeConvert authorizationPrivilegeConvert;
    private final AuthorizationRoleConvert authorizationRoleConvert;
    ...
    public List<PrivilegeDTO> queryPrivilege(Long tenantId, String[] roleCodes) {
        ...
        List<PrivilegeDTO> privilegeDTOS = authorizationPrivilegeConvert.toDto(privileges);
    ...
    public List<PrivilegeDTO> queryPrivilegeByGroupId(Long privilegeGroupId) {
        ...
        List<PrivilegeDTO> privilegeDTOS = authorizationPrivilegeConvert.toDto(privilegeList);
        return privilegeDTOS;
    }
...
/////////////////////////////////////////////角色、权限/////////////////////////////////////////////
    ...
    public void createRole(Long tenantId, RoleDTO role) {
        ...
        AuthorizationRole entity = authorizationRoleConvert.toEntity(role);
    ...
    public List<RoleDTO> queryRole(Long tenantId) {
        ...
        List<RoleDTO> roleDTOS = authorizationRoleConvert.toDto(authorizationRoles);
        return roleDTOS;
    }
    ...
    public RoleDTO queryTenantRole(Long tenantId, String roleCode) {
        ...
        Long id = role.getId();
        RoleDTO roleDTO = authorizationRoleConvert.toDto(role);
    ...
    private PageVO<RoleDTO> buildRoleQuery(RoleDTO roleDTO,Integer pageNo,Integer pageSize) {
        ...
        List<RoleDTO> roleList = authorizationRoleConvert.toDto(roleIPage.getRecords());
        // 封装结果集
